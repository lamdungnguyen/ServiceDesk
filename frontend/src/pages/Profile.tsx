    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', padding: '32px 16px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <h1 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', margin: 0 }}>Account Settings</h1>
          <p style={{ color: '#64748b', marginTop: 6, fontSize: 15 }}>Manage your information, security, and personal preferences.</p>
        </div>
                ...
                <form onSubmit={handleSave}>
                  ...
                  {activeTab === 'personal' && (
                    <div>
                      ...
                      <p style={{ color: '#64748b', fontSize: 14, marginBottom: 28 }}>Update your name and contact email.</p>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: 12, color: '#94a3b8', marginTop: 6 }}>Username cannot be changed. Contact Admin for support.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'security' && (
                    <div>
                      <h2 style={{ fontSize: 20, fontWeight: 800, color: '#0f172a', margin: '0 0 4px' }}>Account Security</h2>
                      <p style={{ color: '#64748b', fontSize: 14, marginBottom: 28 }}>Change your password to keep your account safe.</p>
                  ...
                  {activeTab === 'notifications' && (
                    <div>
                      <h2 style={{ fontSize: 20, fontWeight: 800, color: '#0f172a', margin: '0 0 4px' }}>Notification Settings</h2>
                      <p style={{ color: '#64748b', fontSize: 14, marginBottom: 28 }}>Choose how you want to receive updates from the system.</p>

                      <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                        {[
                          { key: 'emailNotif', icon: <Mail size={22} />, color: '#2563eb', bg: '#eff6ff', title: 'Email Notifications', desc: 'Receive emails for ticket updates or new events.' },
                          { key: 'pushNotif', icon: <Bell size={22} />, color: '#6366f1', bg: '#eef2ff', title: 'Browser Notifications', desc: 'Popup alerts directly on your browser screen.' },
                          { key: 'smsNotif', icon: <Smartphone size={22} />, color: '#10b981', bg: '#ecfdf5', title: 'SMS Notifications', desc: 'Receive SMS for critical emergency events.' },
                        ].map(item => {
                  ...
                  {activeTab === 'preferences' && (
                    <div>
                      <h2 style={{ fontSize: 20, fontWeight: 800, color: '#0f172a', margin: '0 0 4px' }}>Display Preferences</h2>
                      <p style={{ color: '#64748b', fontSize: 14, marginBottom: 28 }}>Personalize the language and theme of the application.</p>
